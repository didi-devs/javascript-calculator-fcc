  ...
  return (
    <div className="container">
      <div className="grid">
        ...
        <div onClick={() => display("/")} className="padButton div operator" id="divide">
          /
        </div>
        <div onClick={() => display("*")} className="padButton times operator" id="multiply">
          *
        </div>
        ...
        <div onClick={() => display("-")} className="padButton minus operator" id="subtract">
          -
        </div>
        ...
        <div onClick={() => display("+")} className="padButton plus operator" id="add">
          +
        </div>
        ...
        <div onClick={calculate} className="padButton equal operator" id="equals">
          =
        </div>
        <div onClick={() => display("0")} className="padButton zero dark-gray" id="zero">
          0
        </div>
        <div onClick={() => display(".")} className="padButton dot operator" id="decimal">
          .
        </div>
      </div>
    </div>
